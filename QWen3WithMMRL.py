...
class QWen3WithMMRL(qwen3_vl.Qwen3VLModel):
    def __init__(self,
        ...
        config.mmrl_config = {
            ...
            "PROTOTYPE_ROUTER_DIM": _cfg_attr(config, "PROTOTYPE_ROUTER_DIM", 128),
            "PROTOTYPE_ROUTER_TEMPERATURE": _cfg_attr(config, "PROTOTYPE_ROUTER_TEMPERATURE", 0.35),
            "PROTOTYPE_ROUTER_HARD_ROUTE": _cfg_attr(config, "PROTOTYPE_ROUTER_HARD_ROUTE", False),
            "PROTOTYPE_ROUTER_CONFIDENCE_TARGET": _cfg_attr(config, "PROTOTYPE_ROUTER_CONFIDENCE_TARGET", 0.55),
