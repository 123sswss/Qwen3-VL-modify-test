...
class VisionWithMMRL(qwen3_vl.Qwen3VLVisionModel):
    def __init__(self, config, *inputs, **kwargs):
        ...
        self.enable_routed_identity_expert = bool(
            getattr(self.cfg, "ENABLE_ROUTED_IDENTITY_EXPERT", False)
        )
        ...
        self.residual_adapters = nn.ModuleList([
            nn.Identity()
            if self.enable_routed_identity_expert and idx == 0
            else zeroInit(self.cfg.vision_token_dim)
