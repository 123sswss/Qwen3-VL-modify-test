...
def split_vision_features(hidden_states, deepstack_feature_lists, grid_thw, spatial_merge_size):
    ...
    Args:
        :param hidden_states: 形状为 (Total_Merged_Tokens, hidden_size) 的 Tensor
        :param deepstack_feature_lists: 包含多个中间层特征的列表，每个 Tensor 形状同上
        :param grid_thw: 形状为 (1+N, 3)，记录每张图的 (T, H, W)
        :param spatial_merge_size: 空间合并系数，默认为 2 (即 2x2 合并)
