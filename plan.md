...
- 512维压缩实验已排入手动目标`pathvqa_directional_concat_workspace_text_dynamic_only_d512_seed44`：相对59.5782参考只把Directional latent宽度从1024降到512，新增视觉`1024->512`投影，文本使用`2560->512`，保持Z10、CA16 heads、层17、P20/S8、全部学习率、seed44/data seed42及3 epochs不变；参数从10,625,536降至**4,591,616**（-56.79%，比LoRA-r8少35.13%）。仅跑epoch3完整Validation、不跑Test；在结果完成前不追加256/768宽度搜索。
