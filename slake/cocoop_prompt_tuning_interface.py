"""Inference interface for CoCoOp-style Prompt checkpoints."""
...
class CoCoOpStyleModelInterface:
    def __init__(self, checkpoint_path: str, base_model_path: str) -> None:
        checkpoint = Path(checkpoint_path).resolve()
        with (checkpoint / COCOOP_CONFIG_NAME).open(
            "r", encoding="utf-8"
        ) as handle:
        ...
        self.model = CoCoOpStylePromptTuningModel(
            base_model,
        ...
        self.model.load_cocoop(checkpoint)
        self.model.eval()
        ...
        print(
            ...
            f"bottleneck={self.model.bottleneck_dim} question_access=false"
        )

    def reset_inference_state(self) -> None:
        self.model.debug_context = {}
