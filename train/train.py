...
EXPERIMENTS = {
    ...
    "visual_router_relation_grouped_lr_v1": {
        **V4_RECOVER_BASE,
        "random_init_adapter_output_count": 0,
        "mmrl_relation_loss_weight": 0.010,
        "mmrl_relation_max_tokens": 64,
        ...
        "stage3_adapter_learning_rates": [8e-5, 8e-5, 8e-5, 8e-5],
    },
...
CFG = {
    ...
    "train": {
        ...
        "mmrl_diagnostics_keep_keys": [
            ...
            "mmrl_token_ratio_p50",
            "mmrl_token_ratio_p90",
            "mmrl_token_ratio_p95",
            "mmrl_token_ratio_p99",
            "mmrl_token_ratio_max",
            "mmrl_token_ratio_over_1_fraction",
            "mmrl_token_ratio_over_1_5_fraction",
            "mmrl_token_ratio_over_2_fraction",
            "final_token_ratio_mean",
            "final_token_ratio_p50",
            "final_token_ratio_p90",
            "final_token_ratio_p95",
            "final_token_ratio_p99",
            "final_token_ratio_max",
            "final_token_ratio_over_1_fraction",
            "final_token_ratio_over_1_5_fraction",
            "final_token_ratio_over_2_fraction",
