...
EXPERIMENTS = {
    ...
    "visual_router_relation_multiturn_step940_v1": {
        **V4_RECOVER_BASE,
        ...
        "stage3_router_learning_rate": 8e-5,
        "stage3_adapter_learning_rates": [4e-5, 6e-5, 8e-5, 1e-4],
        "stage3_max_steps": 940,
        "stage3_warmup_steps": 60,
        "stage3_hold_until_step": 310,
    },
    "visual_router_relation_first_turn_v1": {
        **V4_RECOVER_BASE,
        ...
        "stage3_router_learning_rate": 8e-5,
        "stage3_adapter_learning_rates": [4e-5, 6e-5, 8e-5, 1e-4],
        "stage3_assistant_turn_policy": "first",
    },
    ...
    "visual_router_relation_joint_multiturn_module_lr_v2": {
        **V4_RECOVER_BASE,
        ...
        "stage3_router_learning_rate": 6e-5,
        "stage3_adapter_learning_rates": [4e-5, 6e-5, 8e-5, 1e-4],
        "stage3_assistant_turn_policy": "joint",
        "stage3_data_seed_offset": 0,
    },
    ...
    "visual_router_relation_heterogeneous_adapter_lr_up_v2": {
        **V4_RECOVER_BASE,
        "random_init_adapter_output_count": 0,
        "mmrl_relation_loss_weight": 0.010,
        "mmrl_relation_max_tokens": 64,
        ...
        "stage3_mmrl_learning_rate": 6e-5,
        "stage3_router_learning_rate": 8e-5,
        "stage3_adapter_learning_rates": [5e-5, 7e-5, 9e-5, 1.1e-4],
    },
    "visual_router_relation_heterogeneous_adapter_lr_wide_v3": {
        **V4_RECOVER_BASE,
        "random_init_adapter_output_count": 0,
        "mmrl_relation_loss_weight": 0.010,
        "mmrl_relation_max_tokens": 64,
        ...
        "stage3_mmrl_learning_rate": 6e-5,
        "stage3_router_learning_rate": 8e-5,
        "stage3_adapter_learning_rates": [2e-5, 5e-5, 9e-5, 1.2e-4],
    },
    "visual_router_relation_heterogeneous_adapter_lr_down_v3": {
        **V4_RECOVER_BASE,
        "random_init_adapter_output_count": 0,
        "mmrl_relation_loss_weight": 0.010,
        "mmrl_relation_max_tokens": 64,
        ...
        "stage3_mmrl_learning_rate": 6e-5,
        "stage3_router_learning_rate": 8e-5,
        "stage3_adapter_learning_rates": [3e-5, 5e-5, 7e-5, 9e-5],
    },
