...
CFG = {
    ...
    "train": {
        ...
        "mmrl_diagnostics_keep_keys": [
            ...
            "mmrl_raw_token_specificity_ratio",
            "mmrl_raw_common_direction_cos_ema",
            "mmrl_first_common_mode_ratio",
            "mmrl_first_specificity_ratio",
            "mmrl_common_direction_cos_first_last",
            "mmrl_grad_common_energy_ratio",
            "mmrl_grad_specific_energy_ratio",
            "mmrl_common_objective_alignment",
            "mmrl_specific_objective_alignment",
            "mmrl_grad_pressure",
