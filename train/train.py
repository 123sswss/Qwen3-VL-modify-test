...
BASE_VISUAL_ROUTER_MODEL = {
    ...
    "adapter_router_topk_s3": 2,
    "adapter_router_topk_s4": 1,
...
SELECTED_EXPERIMENT = os.getenv("MMRL_EXPERIMENT", "visual_router_sparse_topk_v1")
